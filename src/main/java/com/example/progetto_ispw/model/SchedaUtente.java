...
public class SchedaUtente extends User {
    ...
    public SchedaUtente (String username, String nome, String email, String cellulare, String dataDiNascita, String bio, String codiceScheda, Vector<Questionario> questionariSvolti) {
        super(username, nome, email, cellulare, dataDiNascita, bio);
